      ...
      <header className="relative w-full pt-[64px]">
        ...
        <div className="relative overflow-hidden bg-background">
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-5 py-24 md:py-32 max-w-3xl mx-auto">
            {/* Marca */}
            <p className="text-livic-pink text-sm font-semibold uppercase tracking-widest mb-4">
              LIVIC
            </p>
            ...
            <p className="text-text-muted text-base md:text-lg max-w-xl leading-relaxed">
              Espacios reales, anfitriones reales, experiencias reales.
              Descubre apartamentos cuidadosamente seleccionados para tu descanso.
            </p>
          </div>
        </div>
      </header>
