...
export default function CatalogHome() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ════════════════════════════════════════════════════════════
          A) HERO — Split layout: texto izquierda + panel derecha
      ════════════════════════════════════════════════════════════ */}
      <header className="relative w-full min-h-screen overflow-hidden">
        ...
        {/* Overlay gradiente izquierdo suave — claro en la zona del texto */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 xl:px-16 min-h-screen flex items-center pt-20 pb-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                {HERO_BULLETS.map((item) => (
                  <li key={item} className="flex items-center gap-3 text-gray-700">
                    <span className="w-5 h-5 rounded-full bg-livic-green/20 flex items-center justify-center flex-shrink-0">
              ...
              <a
                href="#alojamientos"
                className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-livic-pink transition-colors duration-200"
              >
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 w-full max-w-md ml-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {apartments.map((apt) => (
                  <li key={apt.slug}>
                    <Link
                      ...
                      className="text-gray-500 text-sm hover:text-livic-pink transition-colors duration-200"
                    >
                      {apt.nombre}
                    </Link>
                  </li>
                ...
                {apartments.length === 0 && (
                  <li className="text-gray-400 text-sm">Próximamente</li>
                )}
              </ul>
            </div>
