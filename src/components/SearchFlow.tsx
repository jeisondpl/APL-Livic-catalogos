              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 mb-12'>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <a href='https://es-l.airbnb.com/rooms/1608385896028957180' target='_blank' rel='noopener noreferrer' aria-label='Airbnb'
                ...
                <div>
                  ...
                  <ul className='space-y-3'>
                    ...
                    <li>
                      <a href='https://es-l.airbnb.com/rooms/1608385896028957180' target='_blank' rel='noopener noreferrer'
