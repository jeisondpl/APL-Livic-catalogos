...
export default function Hero({ apartment }: HeroProps) {
  return (
    <div className="relative w-full h-[70vh] min-h-[450px] max-h-[800px] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-livic-black via-livic-black/40 to-transparent" />
      ...
      <div className="relative z-10 flex flex-col justify-end h-full px-5 md:px-8 pb-10 md:pb-16 max-w-4xl mx-auto w-full">
        ...
        {/* Título principal */}
        <h1 className="text-4xl md:text-6xl font-bold text-livic-white leading-tight mb-4">
          {apartment.nombre}
        </h1>

        {/* Descripción corta */}
        <p className="text-text-muted text-lg md:text-xl max-w-2xl mb-8 leading-relaxed">
